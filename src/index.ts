...
<body>
    <div class="video-container">
        ...
        <div class="server-buttons">
            ...
            <a href="javascript:void(0)" onclick="changeServer('https://www.livereacting.com/tools/hls-player-embed?url=https://wax.emblazonn.com/live/v1/RknzgN7FDh7aRIgASnESQzYuskSNgwYew0WnAG8eb8fVSWMlODu5eoSKveEWtEx+/master.m3u8')" class="server-button">SERVER 3</a>
        </div>
    </div>
